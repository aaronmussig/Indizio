...
setup(name='indizio-dev',
      ...
      install_requires=[
          'dash>=2.14.0', 'dash-bootstrap-components>=1.5.0',
          'dash-cytoscape', 'diskcache', 'dash[diskcache]',
          'dash-bio', 'pydantic>=2.5.0', 'networkx', 'orjson',
          'dendropy', 'frozendict', 'pillow', 'pandas', 'numpy',
          'tqdm', 'scipy', 'phylodm>=3.0.0'
      ],
